...
const GetBookCoverSchema = z.object({
  ...
  size: z
    ...
    .optional()
    .transform((val: string | null | undefined) => val || "L"),
});
...
class ReadingTrackerMCPServer {
  ...
  private openLibraryApi: AxiosInstance;
  private readingTrackerApi: AxiosInstance;
  ...
  private async handleSearchBooksByTitle(args: unknown): Promise<CallToolResult> {
  ...
  private async handleSearchAuthorsByName(args: unknown): Promise<CallToolResult> {
    ...
    try {
      ...
      const authors = response.data.docs.map((author: any) => ({
        key: author.key,
        name: author.name,
  ...
  private async handleGetBookById(args: unknown): Promise<CallToolResult> {
  ...
  private async handleGetAuthorInfo(args: unknown): Promise<CallToolResult> {
  ...
  private async handleGetBookCover(args: unknown): Promise<CallToolResult> {
  ...
  private async handleGetAuthorPhoto(args: unknown): Promise<CallToolResult> {
  ...
  private async handleEnrichBookData(args: unknown): Promise<CallToolResult> {
